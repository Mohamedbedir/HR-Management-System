...
{
    public class AddJobPostingValidator:AbstractValidator<AddJobPostingCommand>
    {
        ...
        public AddJobPostingValidator(IDepartmentService departmentService,
        ...
        {
            RuleFor(s => s.Title)
                .MustAsync(async (key, cancellationToken) => !await jobPostingService.IsJobPostingExist(key))
